...
\section*{Introduction}
	...
	\begin{frame}
		...
		Starting with an incomplete triangulation, add points recursively.
		Adding a point means creating new triangles with the points of existing triangles with circumscribed circles that contain the new point.
	\end{frame}
